...
pygame.init()
display_surf = pygame.display.set_mode((640,480), pygame.HWSURFACE) #sets hardware surface

if not pygame.font: print 'Warning, fonts disabled'
if not pygame.mixer: print 'Warning, sound disabled'
bits = 16
pygame.mixer.pre_init(44100, -bits, 2,2048)
d = {"C4","D4","E4"}
songs = [("E4",.9),("D4",1),("C4",1),("D4",1),("E4",1),("E4",1),("E4",2),("D4",1),("D4",1),("D4",2),("E4",1),("G4",1),("G4",2),("E4",1),("D4",1),("C4",1),("D4",1),("E4",1),("E4",1),("E4",1)]
class sounder:
    def __init__(self):
        self.a = 0
    def blip(self,j):
    ...
    def songPlay(self):
        num = 1
        for i in songs:
            winsound.PlaySound("C:pianos/Piano.mf."+ i[0] +".wav",winsound.SND_FILENAME|winsound.SND_ASYNC)
            if(num == 5):
                num = 1
            self.blip(num)
            time.sleep(i[1])
            ...
            if not frame.fingers.is_empty:#checks fingers
                if not fingers1.is_empty: #checks if fingers from first hand are present
                    ...
                    if self.check != freq_split:
                        ...
                        #pygame.mixer.stop()
                        #self.sounders.player(freq_split)
